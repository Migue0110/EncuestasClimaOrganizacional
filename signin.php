...
<head>
    <meta charset="utf-8">
    <title>Estudios Psicologicos Contestar encuesta</title>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="img/mario.jpg" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">Nickson Gomez</h6>
                        <span>Empleado</span>
                    </div>
                </div>
                <!-- 
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="button.html" class="dropdown-item">Agregar Preguntas</a>
                            <a href="typography.html" class="dropdown-item">Seleccionar Preguntas</a>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="#" class="dropdown-item">
                                <h6 class="fw-normal mb-0">Responder encuesta</h6>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="img/mario.jpg" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">Nickson Gomez</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-dark">
                                    ...
                                    <th scope="col"></th>
                                    <th scope="col"><img class="iconhome" src="img/Muy insatisfecho.png ">Muy insatisfecho</th>
                                    <th scope="col"><img class="iconhome" src="img/Insatisfecho.png">Insatisfecho</th>
                                    <th scope="col"><img class="iconhome" src="img/Neutro.png">Neutro</th>
                                    <th scope="col"><img class="iconhome" src="img/Satisfecho.png">Satisfecho</th>
                                    <th scope="col"><img class="iconhome" src="img/Muy satisfecho.png">Muy satisfecho</th>
                                    <th scope="col"><img class="iconhome" src="img/not_apply.png">No aplica</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        ...
                        <!-- imgs -->
                        <div class="col-12 col-sm-6 text-center text-sm-end d-flex align-items-center justify-content-sm-end">
                            <img class="iconhome" src="/img/icoep.png" alt="">
                            <img class="iconhome" src="/img/icouan.png" alt="">
                            <a class="btn btn-sm btn-primary ms-2" href="">Guardar</a>
                            <a class="btn btn-sm btn-primary ms-2" href="">Siguiente</a>
                        </div>
                    </div>
                </div>
            </div>
