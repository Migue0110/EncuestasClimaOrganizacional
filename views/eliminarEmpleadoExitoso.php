...
<div class="d-flex justify-content-center align-items-center" id="main-container" style="height: 60vh;">
  ...
  <div class="card-header fs-4 tituloprincipal" id="header"><b>Empleado Eliminado</b>
     <div class="circle"><i class="bi bi-check"></i></div>
  </div>
    <h5 class="card-title mb-3 textbody" id="title">El empleado se eliminó con éxito</h5>
